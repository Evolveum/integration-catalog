...
public class RepositoryUtil {
    ...
    public static IntegrationMethod findIntegrationMethod(UUID id, String revision, IntegrationMethodRepository integrationMethodRepository) {
    ...
    public static ConnectorVersion findConnectorVersion(String id, String revision, ConnectorVersionRepository connectorVersionRepository) {
