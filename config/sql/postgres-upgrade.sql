...
ALTER TABLE maintainers ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME maintainers_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY connector_bundle_maintainers
    ADD CONSTRAINT connector_bundle_maintainers_pkey PRIMARY KEY (connector_bundle_id, maintainers_id);

ALTER TABLE ONLY connector_bundle_version_maintainers
    ADD CONSTRAINT connector_bundle_version_maintainers_pkey PRIMARY KEY (connector_bundle_version_id, connector_bundle_version_revision, maintainers_id);

CREATE INDEX idx_cbmaint_maintainers_item      			ON connector_bundle_maintainers USING btree (maintainers_id, connector_bundle_id);
CREATE INDEX idx_cbvmaint_maintainers_item    			ON connector_bundle_version_maintainers USING btree (maintainers_id, connector_bundle_version_id, connector_bundle_version_revision);
...
ALTER TABLE ONLY integration_method_authors
...
-- TODO before applying export DB
-- region change 9: TODO
